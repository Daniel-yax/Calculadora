...
public class Integrar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cab.setBackground(new java.awt.Color(255, 255, 204));
        cab.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "x", "y" }));
        ...
        text.setBackground(new java.awt.Color(153, 102, 255));
                            ...
                            .addGroup(jintegrarLayout.createSequentialGroup()
                                .addGroup(jintegrarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jintegrarLayout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)))
                                .addGroup(jintegrarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jintegrarLayout.createSequentialGroup()
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jintegrarLayout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(mensaje, javax.swing.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE)))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jintegrarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
// Declarar una variable de instancia para almacenar el coeficiente seleccionado
private String coeficiente = ""; // Puedes inicializarla con un valor predeterminado
    private void ResultadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ResultadoActionPerformed
        // Obtener el valor seleccionado del JComboBox y actualizar la variable coeficiente
    coeficiente = (String) cab.getSelectedItem();
    // No es necesario establecerlo en el JTextField Tex aquí, ya que lo necesitas en ResultadoActionPerformed
        try {
    ...
    String seleccion = (String) cab.getSelectedItem();
    
    // Establecer el valor en el JTextField
    text.setText(seleccion);    
